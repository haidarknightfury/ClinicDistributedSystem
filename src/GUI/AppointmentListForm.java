...
public class AppointmentListForm {
	...
	private ObservableList<AppointmentPatient> appointments = FXCollections.observableArrayList();
	private TableView<AppointmentPatient> table = new TableView<AppointmentPatient>();
	...
	private TableColumn<AppointmentPatient,String> dateCol = new TableColumn<AppointmentPatient,String>("appointmentDate");
	private TableColumn<AppointmentPatient,String> SnameCol = new TableColumn<AppointmentPatient,String>("patientSurname");
	private TableColumn<AppointmentPatient,String> FnameCol = new TableColumn<AppointmentPatient,String>("patientOtherNames");
	private TableColumn<AppointmentPatient,String> STimeCol = new TableColumn<AppointmentPatient,String>("appointmentStartTime");
	private TableColumn<AppointmentPatient,String> ETimeCol = new TableColumn<AppointmentPatient,String>("appointmentEndTime");

	public Scene CreateAppointmetListScene() {
		...
		Label lblTotal=new Label("TOTAL PRODUCTS");
		...
		setAnimation();
		int sum=0;
		for (AppointmentPatient appointment : appointments) {
			sum++;
		}
	...
	private void configureTable(StackPane root) {
		...
		table.getColumns().addAll(SnameCol,FnameCol,dateCol,STimeCol,ETimeCol,actionCol);
	...
	private void configureSearch(StackPane root) {
		...
		Label searchTitle = LabelBuilder.create().text("SEARCH PRODUCT").font(Font.font("Arial", 20)).build();
		searchField = new TextField();
		HBox hb = HBoxBuilder.create().children(LabelBuilder.create().text("ENTER PRODUCT: ").font(Font.font("Arial", 14)).build(), searchField).maxHeight(24).translateY(45).build();
	...
	public TableColumn<AppointmentPatient, String> getDateCol() {
		return dateCol;
	}

	public void setDateCol(TableColumn<AppointmentPatient, String> dateCol) {
		this.dateCol = dateCol;
	}

	public TableColumn<AppointmentPatient, String> getSnameCol() {
		return SnameCol;
	}

	public void setSnameCol(TableColumn<AppointmentPatient, String> snameCol) {
		SnameCol = snameCol;
	}

	public TableColumn<AppointmentPatient, String> getFnameCol() {
		return FnameCol;
	}

	public void setFnameCol(TableColumn<AppointmentPatient, String> fnameCol) {
		FnameCol = fnameCol;
	}

	public TableColumn<AppointmentPatient, String> getSTimeCol() {
		return STimeCol;
	}

	public void setSTimeCol(TableColumn<AppointmentPatient, String> sTimeCol) {
		STimeCol = sTimeCol;
	}

	public TableColumn<AppointmentPatient, String> getETimeCol() {
		return ETimeCol;
	}

	public void setETimeCol(TableColumn<AppointmentPatient, String> eTimeCol) {
		ETimeCol = eTimeCol;
	}

	public ObservableList<AppointmentPatient> getAppointments() {
		return appointments;
	}

	public void setAppointments(ObservableList<AppointmentPatient> appointments) {
		this.appointments = appointments;
	}

	public TableView<AppointmentPatient> getAppointmentPatientTable() {
		return table;
	}

	public void setTable(TableView<AppointmentPatient> table) {
		this.table = table;
	}
