...
public class DoctorPendingAppointmentForm {
	...
	private ObservableList<PendingAppointment> PendingAppointmentList = FXCollections.observableArrayList();

	private TableView<PendingAppointment> table = new TableView<PendingAppointment>();
	private Button btnAdd;
	private Button btnExit;
	private  TableColumn actionCol=new TableColumn<>();
	private TableColumn<PendingAppointment, String> DocIDCol = new TableColumn<PendingAppointment,String>("DoctorID");
	private TableColumn<PendingAppointment, String> PatIDCol = new TableColumn<PendingAppointment,String>("PatientID");
	private TableColumn<PendingAppointment,String> ReasonCol = new TableColumn<PendingAppointment,String>("BriefReason");
	private TableColumn<PendingAppointment, String> DateCol = new TableColumn<PendingAppointment,String>("Date");

	

	public Scene CreatePendingAppointmentListForm() {
	...
	private void configureTable(StackPane root) {
		...
		table.getColumns().addAll(DocIDCol,PatIDCol,ReasonCol,DateCol,actionCol);
		...
		searchBtn.setOnAction(new EventHandler<ActionEvent>() {
			...
			public void handle(ActionEvent paramT) {
				...
				if(str!=null && str.length()>0){
					...
					table.getItems().addAll(PendingAppointmentList);
				}
			}
		});
